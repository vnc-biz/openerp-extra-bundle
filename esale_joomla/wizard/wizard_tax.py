...
_export_done_fields = {
    'new': {'string': 'New Taxes', 'type': 'integer', 'readonly': True},
    'update': {'string': 'Updated Taxes', 'type': 'integer', 'readonly': True},
    'delete': {'string': 'Deleted Taxes', 'type': 'integer', 'readonly': True},
